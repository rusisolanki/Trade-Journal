export const headings = {
    equityTrade: ['ID', 'Date', 'Symbol', 'Entry Quantity', 'Entry Price', 'Stoploss(SL)', 'SL%', 'Position Size(PS)', 'PS%', 'Risk Per Trade(RPT)', 'RPT%', 'Exit%', 'Exit Price', 'Gain%', 'Capital Deployed', 'RoCD', 'Starting Account Value', 'ROSV', 'Account Value', 'Account Gain%', 'Days', 'RR', 'Net Profit', 'Action'],
    futureTrade: ['ID', 'Date', 'Symbol', 'Entry Quantity', 'Expiry Date', 'Lot Size', 'Entry Price', 'Stoploss(SL)', 'SL%', 'Position Size(PS)', 'PS%', 'Risk Per Trade(RPT)', 'RPT%', 'Exit%', 'Exit Price', 'Gain%', 'Capital Deployed', 'RoCD', 'Starting Account Value', 'ROSV', 'Account Value', 'Account Gain%', 'Days', 'RR', 'Net Profit', 'Action'],
    ...
    exit: ['Exit Date', 'Exit Price', 'Exit%', 'Days', 'Exit Quantity', 'Charges', 'Profit', 'R Multiple', 'Action'],
